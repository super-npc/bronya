...
@TableIndexes({@TableIndex(fields = {RabbitWork.Fields.entityClass}, type = IndexTypeEnum.UNIQUE)})
public class RabbitWork {
    ...
    @Exclude
    @BindOne2Many(entity = RabbitWorkMsg.class, condition = @JoinCondition(selfField = RabbitWork.Fields.id,
            joinField = RabbitWorkMsg.Fields.rabbitWorkId, joinFieldLabel = RabbitWorkMsg.Fields.entityClass))
    private List<RabbitWorkMsg> wxAppDetails;
    ...
    @Data
    public static class RabbitWorkExpandFields {
